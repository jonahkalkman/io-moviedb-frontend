  ...
  return (
    <div className="w-full" role="search">
      ...
      <div className="relative">
        ...
        <input
          aria-label="Search through movie titles"
          className="block w-full rounded-md border border-gray-300 bg-white py-2 pl-10 pr-3 text-sm placeholder-gray-500 sm:text-sm"
          placeholder="Search"
          type="search"
          required
          value={searchValue}
